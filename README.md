...
**[Hello React on Rails]** is a Ruby on Rails application that front-end is implemented using React as a SINGLE APP. The combination of React and Rails.
